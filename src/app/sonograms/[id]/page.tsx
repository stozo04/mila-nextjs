...
const sonograms = {
    ...
    '2': {
        ...
        description: 'I had a great Christmas. I got to meet my dads side of the family!',
        age: '17 weeks'
    },
    '3': {
        title: 'Sonogram 3',
                    ...
                    <article className="portfolio">
                        <div className="row"> {/* Added a row for horizontal layout */}
                            ...
                            <div className="d-flex justify-content-between mt-4">
                                {params.id !== '1' && ( // Show "Previous" if not the first sonogram
                                    <Link
                                ...
                                <div> {/* Added a container for the "Next" button */}
                                    {params.id !== '5' && ( // Show "Next" if not the last sonogram
                                        <Link
                                            href={`/sonograms/${parseInt(params.id) + 1}`}
