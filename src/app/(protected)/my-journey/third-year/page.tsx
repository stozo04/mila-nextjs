...
export default function ThirdYearPage() {
  ...
  useEffect(() => {
    async function fetchCards() {
      try {
        const journeyCards = await getJourneyCards(JourneyType.THREE_YEAR);
    ...
    <div className="container py-5">
      <div className="row mb-4">
        <div className="col-12 text-center">
          <h1 className="display-4 mb-3">My Sweet Third Year</h1>
          <p className="lead">Three and full of wonder &mdash; bigger adventures, bigger giggles, big-kid milestones!</p>
      ...
      <CreateJourneyCardModal
        ...
        journeyType={JourneyType.THREE_YEAR}
      />
          ...
          <div key={card.slug} className="col-md-6 col-lg-4">
            <div className="card h-100">
              ...
              <div className="card-footer bg-transparent border-0">
                <button
                  onClick={() => router.push(`./third-year/${card.slug}`)}
