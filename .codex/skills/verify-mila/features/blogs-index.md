...
- **Confirm the gate.** Open `/blogs` signed out. Run `node .codex/skills/verify-mila/control-mila.mjs get /blogs --save blogs-index/anonymous`. Status is `307` with `location: /login`.
