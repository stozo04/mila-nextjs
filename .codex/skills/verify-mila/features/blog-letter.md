...
- **Confirm the gate.** Open a letter signed out. Run `node .codex/skills/verify-mila/control-mila.mjs get /blogs/any-slug --save blog-letter/anonymous`. Status is `307` with `location: /login`.
