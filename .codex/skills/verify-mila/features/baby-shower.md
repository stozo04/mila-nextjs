...
- **Confirm the gate.** Open a city signed out. Run `node .codex/skills/verify-mila/control-mila.mjs get /baby-shower/houston --save baby-shower/anonymous`. Status is `307` with `location: /login`.
