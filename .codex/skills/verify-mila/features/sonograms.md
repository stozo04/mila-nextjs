...
- **Confirm the gate.** Open `/sonograms` signed out. Run `node .codex/skills/verify-mila/control-mila.mjs get /sonograms --save sonograms/anonymous`. Status is `307` with `location: /login`.
